...
public class CardViewNowPlayingMovieAdapter extends RecyclerView.Adapter<CardViewNowPlayingMovieAdapter.CardViewViewHolder> {
    private ArrayList<Movie> listMovies;
    private Context context;

    CardViewNowPlayingMovieAdapter(Context context) {
    ...
    void setListMovie(ArrayList<Movie> listMovies){
        this.listMovies = listMovies;
    }

    @Override
    public CardViewNowPlayingMovieAdapter.CardViewViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_cardview_now_playing_movies, parent, false);
        return new CardViewViewHolder(view);
    }

    @Override
    public void onBindViewHolder(CardViewNowPlayingMovieAdapter.CardViewViewHolder holder, int position) {
        ...
        holder.btnDetail.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                ...
                intent.putExtra(DetailMovieActivity.EXTRA_ID,20);
        ...
        holder.btnShare.setOnClickListener(new CustomOnItemClickListener(position, new CustomOnItemClickListener.OnItemClickCallback() {
            ...
            public void onItemClicked(View view, int position) {
                ...
                try{
                    ...
                    sendIntent.putExtra(Intent.EXTRA_TEXT, "Now I am Playing" + movie.getTitle() + " on The Movie DB");
