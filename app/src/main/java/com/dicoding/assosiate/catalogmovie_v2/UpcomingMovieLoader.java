...
public class UpcomingMovieLoader extends AsyncTaskLoader<ArrayList<Movie>> {
    private boolean hasResult = false;
    private ArrayList<Movie> mData;
    private String cari;
    private static String API_KEY = "738b79e3ef5d0c5080144c9389006f92";

    public UpcomingMovieLoader(Context context, String sCari) {
        super(context);
        this.cari = sCari;
        onContentChanged();
    }
    ...
    public ArrayList<Movie> loadInBackground() {
        ...
        //String url = "https://api.themoviedb.org/3/search/movie?api_key="+API_KEY+"&language=en-US&query="+ cari;
